...
import PersonnalDetailsForm from "./components/PersonalDetailsForm";
...
import GeneralSkillForm from "./components/GeneralSkillForm";
...
export default function Home() {
  ...
  const [generalSkills, setGeneralSkills] =
    useState<GeneralSkill[]>(generalSkillsPreset);
  ...
  const handleResetGeneralSkills = () => setGeneralSkills([]);
    ...
    <div>
      <div className="hidden lg:block">
        <section className="flex items-center h-screen">
          <div className="w-1/3 h-full p-10 bg base-200 scrollable no-scrollbar">
            ...
            <div className="flex flex-col gap-6 rounded-lg">
              <div className="flex justify-between items-center">
                <h1 className="badge badge-primary badge-putline">
                  Qui êtes-vous ?
                </h1>
                <button
              ...
              <div className="flex justify-between">
                <div className="w-1/2">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      onClick={handleResetGeneralSkills}
                      className="btn btn-primary btn-sm"
                    >
                      <RotateCw className="w-4" />
                    </button>
                  ...
                  <GeneralSkillForm
                    ...
                    setGeneralSkills={setGeneralSkills}
                  />
                </div>
          ...
          <div
            className="w-2/3 h-full bg-base-100 bg-[url('/file.svg')] 
          bg-cover bg-center scrollable-preview relative"
          >
            <div
              className="flex items-center justify-center fixed z-[999] top-5
            right-5"
            >
              <input
                type="range"
            ...
            <select
              ...
              className="select select-bordered fixed z-[999] select-sm top-12 
          right-5"
            >
        ...
        <dialog id="my_modal_3" className="modal">
          <div className="modal-box w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-5">
              ...
              <div className="w-full maw-x-full overflow-auto">
